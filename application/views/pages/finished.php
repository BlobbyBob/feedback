...
<div id="finished_wrapper">
    <div id="finished" class="jumbotron text-xs-center container">
        <h1 class="display-3">Vielen Dank!</h1>
        <p class="lead">Jede Rückmeldung wirkt sich positiv auf den Betrieb der Halle aus.</p>
        <hr>
        <p>
